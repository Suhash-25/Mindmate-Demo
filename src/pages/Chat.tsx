...
const Chat = () => {
  ...
  const analyzeSentiment = (text: string): 'positive' | 'neutral' | 'negative' => {
    // This is a very simple sentiment analysis for demo purposes
  ...
  const generateResponse = (userMessage: string, userSentiment: 'positive' | 'neutral' | 'negative'): string => {
    // This simulates an AI response based on sentiment
    // In a real app, you would use a proper NLP/LLM model like GPT
